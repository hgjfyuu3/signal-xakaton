...
public class VkBot extends LongPollBot {
        ...
        try {
            ...
            if (userStateMap.get(userId) == UserState.START) {
                ...
                if (message.getText().equals("Закончить диалог и вернуться назад")) {
                    ...
                    String requestGiga = gigaService.requestGiga(message.getText(), userId, "Представь что ты искусственный интеллект администрации и ответь на вопрос", true);
                    send(userId,
                            requestGiga + "\n\nЕсли вы желаете продолжить обсуждение, то, пожалуйста, продолжайте вести диалог.",
                            createAskQuestionKeyboard());
                }
    ...
    private void processUserMessage(Message message) throws VkApiException {
        ...
        } else if (userText.equalsIgnoreCase("FAQ")) {
            String faqText = """
                    ...
                    4. Что делать при возникновении проблем с услугами?
                    ...
                    5. Как изменить личные данные в учетной записи?
                    ...
                    6. Как оценить качество предоставляемых услуг?
                    ...
                    7. Как получить справку или подтверждение об оказанных услугах?
                    ...
                    8. Как подписаться на новостную рассылку?
    ...
    private Keyboard getStartedKeyboard() {
        ...
        List<Button> buttons4 = Arrays.asList(
                createButton("FAQ", Button.Color.POSITIVE) // топ вопросов
        );
